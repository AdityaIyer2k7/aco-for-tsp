...
class Colony:
    def __init__(self, rand:random.Random, cities:Iterable[City], ants:Iterable, decay:float, max_iter:int,
...
def init():
    ...
    colony = Colony(random.Random(), cities, ants, DECAY, 1000, 0.3, 0.5, -0.4, 0,0)
